...
import static com.gavin.date.TmDateUtil.Format_Date;
import static com.gavin.date.TmDateUtil.Format_DateTime;
import static com.gavin.date.TmDateUtil.parse;
...
public class TmDateTimeUtil {
    ...
    public static TmTimeInterval getDateTime(String dateTime, String timeDate) {
        Date date = parse(timeDate, Format_Date);
    ...
    public static String getNextMonth(String dateString) {
        org.joda.time.DateTime datetime = new org.joda.time.DateTime(parse(dateString));
        return datetime.plusMonths(1).toString("yyyy-MM-dd");
    }
