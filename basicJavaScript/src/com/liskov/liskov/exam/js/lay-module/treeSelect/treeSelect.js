...
function(c,a,b,f){(!a||!d.isHidden(c,a))&&s.apply(e,arguments)};var t=e.repairParentChkClassWithSelf;if(t)e.repairParentChkClassWithSelf=function(c,a){(!a||!d.isHidden(c,a))&&t.apply(e,arguments)}})(jQuery);
  ...
  TreeSelect.prototype.render = function (options) {
    ...
    var a = {
      ...
      getLevelName: function(node) {
        if(node != null) {
          var pnode = node.getParentNode();
          if (pnode != null) {
            return a.getLevelName(pnode) + " > " + node.name;
          } else {
            return node.name;
          }
        }
      ...
      onClick: function (event, treeId, treeNode) {
        var name = a.getLevelName(treeNode),
          id = treeNode.id,
  ...
  var obj = {
    getLevelName: function(node) {
      if(node != null) {
        var pnode = node.getParentNode();
        if (pnode != null) {
          return obj.getLevelName(pnode) + " > " + node.name;
        } else {
          return node.name;
        }
      }
